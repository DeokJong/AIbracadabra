...
public class KakaoClient {
     ...
     * 주소 → 좌표 변환
     */
    public Mono<AddressSearchResponse> searchAddress(String query,
                                                     String analyzeType,
                                                     Integer page,
                                                     Integer size) {
     ...
     * 좌표 → 행정구역정보 변환
     */
    public Mono<RegionCodeResponse> coord2RegionCode(double x,
                                                     double y,
                                                     String inputCoord,
                                                     String outputCoord) {
        return kakaoApiWebClient.get()
     ...
     * 좌표 → 주소 변환
     */
    public Mono<Coord2AddressResponse> coord2Address(double x,
                                                     double y,
                                                     String inputCoord) {
        return kakaoApiWebClient.get()
                .uri(uri -> uri
     ...
     * 좌표계 변환
     */
    public Mono<TransCoordResponse> transCoord(double x,
                                               double y,
                                               String inputCoord,
                                               String outputCoord) {
        return kakaoApiWebClient.get()
    ...
    public Mono<SearchResponse> searchKeyword(String query,
                                              Integer page,
                                              Integer size) {
        return this.searchKeyword(query, page, size, null, null, 20000, "accuracy");
    }
     ...
     * 카테고리로 장소 검색
     */
    public Mono<SearchResponse> searchCategory(String categoryGroupCode,
                                               Double x,
                                               Double y,
                                               Integer page,
                                               Integer size,
